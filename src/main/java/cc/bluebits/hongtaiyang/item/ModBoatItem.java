...
public class ModBoatItem extends Item {
	...
	/**
	 * Constructs a new ModBoatItem
	 * @param pHasChest Whether the boat has a chest
	...
	private Boat getBoat(Level pLevel, HitResult pHitResult) {
		return this.hasChest ?
				new ModChestBoatEntity(pLevel, pHitResult.getLocation().x, pHitResult.getLocation().y, pHitResult.getLocation().z) :
